...
describe "User pages" do
  ...
  describe "profile page" do
    ...
    it { should have_selector('h1',    text: coder.encode(user.name, :hexadecimal)) }
    it { should have_selector('title', text: coder.encode(user.name, :hexadecimal)) }
